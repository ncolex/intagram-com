...
const Login = () => {
    ...
    return (
        <div className='w-3/13 py-1 justify-center items-center'>
            <div className='w-3/13 mx-8 my-2 h-3/5 bg-white items-center flex flex-col border-solid border-2 border-gray-200'>
                ...
                <br />
                <form className='bg-white-900 flex flex-col w-80 h-80 m-1 justify-center items-center' style={{ marginTop: -25 }} onSubmit={submitForm}>
                    ...
                    <a href="https://www.facebook.com/" className='-mt-3 my-2 w-full flex h-12 text-sm font-medium text-blue-900 justify-center items-center'><p className='mr-2'><img className='h-4' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsopFzwl5NhkdQf74U92qjJBsfVbilRK2S1b2HgaT4sg&s" alt="" srcSet="" /></p>Log in with Facebook</a>
                    <div className='bg-white-900 text-sm text-red-600'>{loginState}</div>
                    <Link to="/accounts/password/reset/"><span style={{ marginTop: -25 }} className='flex h-16 text-xs justify-center items-center'>Forgot password?</span></Link>
                </form>
            </div>
            <div className='bg-white flex justify-center items-center h-16 w-3/13 mx-8 border-solid border-2 border-gray-200 '>
                <p className='text-sm'>Don't have an account? &nbsp;
                    <Link to='/accounts/emailsignup/' className='text-cyan-600 font-medium'>Sign up</Link></p>
            </div>
            <p className='text-sm mt-5 w-fit mx-auto'>Get the app.</p>
            <div className='h-16 w-8/12 m-3 w-fit mx-auto flex justify-center items-center '>
                ...
                <a href="https://www.microsoft.com/store/productId/9NBLGGH5L9XT"><img className='h-10 w-32 -ml-3' alt="Get it from Microsoft" src="https://static.cdninstagram.com/rsrc.php/v3/yu/r/EHY6QnZYdNX.png"></img></a>
            </div>
        </div>
    )
}
